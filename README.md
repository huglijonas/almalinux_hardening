...
A report is available [here](https://github.com/huglijonas/almalinux_hardening/blob/0.1.1/reports/level1_security_guide.html).
...
This module affects a lot of parameters. The following list is not exhaustive, so it is recommanded to read [the full report](https://github.com/huglijonas/almalinux_hardening/blob/0.1.1/reports/level1_security_guide.html) before using the module:
* Kernel settings ;
