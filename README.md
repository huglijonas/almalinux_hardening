...
A report is available [here](https://github.com/huglijonas/almalinux-hardening/reports/level1_security_guide.html).
...
This module affects a lot of parameters. The following list is not exhaustive, so it is recommanded to read [the full report](https://github.com/huglijonas/almalinux-hardening/reports/level1_security_guide.html) before using the module:
* Kernel settings ;
...
You can contribute on the official page: https://github.com/huglijonas/almalinux-hardening
